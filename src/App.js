...
const useStyles = makeStyles(theme => ({
  ...
  image: {
    backgroundImage:
      'url(' +
      'https://scontent.fjnb11-1.fna.fbcdn.net/v/t1.6435-9/218230350_6101479503258632_6092955877124397050_n.jpg?_nc_cat=105&ccb=1-3&_nc_sid=730e14&_nc_ohc=zEKmEY_xh1kAX-g2prU&tn=6VvZ5GfI6aYD5Tzn&_nc_ht=scontent.fjnb11-1.fna&oh=f6986bd9697e9260806d95cbeb05f224&oe=612AD072' +
      ')',
    width: '700px',
    height: '600px',
    overflow: 'visible',
...
function Signup() {
  ...
  return (
    <Grid
      ...
      container
      spacing={0}
      style={{ padding: '20px', position: 'fixed' }}
      className={classes.paperSyle}
    >
    ...
    <Router>
      <Grid
        style={{
          ...
          backgroundImage:
            'url(' +
            'https://scontent.fjnb11-1.fna.fbcdn.net/v/t1.6435-9/220410270_6101483326591583_5306378977487393636_n.jpg?_nc_cat=107&ccb=1-3&_nc_sid=730e14&_nc_ohc=Mzk5NExrAZEAX_mxea_&_nc_ht=scontent.fjnb11-1.fna&oh=c895bcb3c89cacaa6ae2ea62f0e2bacf&oe=612970A5' +
            ')',
          backgroundSize: 'cover',
          backgroundRepeat: 'no-repeat',
          backgroundPosition: 'center',
      ...
      >
        ...
        >
          <FormControlLabel
            value=""
            control={<Radio />}
            label="Write about time blocking"
          />
          <List style={{ listStyleType: 'none', padding: 0, color: 'black' }}>
            <ListItem>
